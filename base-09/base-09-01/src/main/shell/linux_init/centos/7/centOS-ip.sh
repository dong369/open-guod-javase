#!/bin/bash
## 设置IP（centos6、7）
#执行脚本命令：sh CentOS-IP.sh ens33 192.168.100.12 255.255.255.0 192.168.100.2
#执行脚本命令：sh CentOS-IP.sh ens33 192.168.100.12 255.255.255.0 192.168.100.2 dg
if [[ "$1" == "" ]];then
    echo "1 is empty.example:CentOS-IP.sh ens33 192.168.100.12 255.255.255.0 192.168.100.2"
    exit 1
fi
if [[ "$2" == "" ]];then
    echo "2 is empty.example:CentOS-IP.sh ens33 192.168.100.12 255.255.255.0 192.168.100.2"
    exit 1
fi
if [[ "$3" == "" ]];then
    echo "3 is empty.example:CentOS-IP.sh ens33 192.168.100.12 255.255.255.0 192.168.100.2"
    exit 1
fi
if [[ "$4" == "" ]];then
    echo "4 is empty.example:CentOS-IP.sh ens33 192.168.100.12 255.255.255.0 192.168.100.2"
    exit 1
fi
